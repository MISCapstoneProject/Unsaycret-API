...
class VADConfig:
    ...
    PRESETS = {
        "custom": {
            "name": "自訂模式",
            "description": "盡量切除空聲音片段，只用於辨識，可能會少量切掉語音",
            "energy_threshold": -52.0,
            "loud_threshold": -47.0,
            "zcr_min": 0.015,
            "zcr_max": 0.28,
            "min_voice_duration": 0.29,
            "padding": 0.08
        },
        "strict": {
            "name": "嚴格模式",
...
class VADProcessor(VoiceActivityDetector):
    ...
    def __init__(self, preset: str = "custom", method: str = "speechbrain", **custom_params):
        """
        初始化VAD處理器
