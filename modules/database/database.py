...
新版本請使用：
-------------
- weaviate_connection.py (Weaviate 連線管理)
- weaviate_crud.py (Speaker/VoicePrint CRUD 操作)
- mongodb_connection.py (MongoDB 連線管理)
- mongodb_crud.py (Session/Transcript/AISummary CRUD 操作)
...
⚠️ 請勿在新代碼中使用此檔案！
⚠️ 新版本穩定後（預計 2-4 週），此檔案將被刪除

計劃：
-----
- 保留期限：2025-01-14 ~ 2025-02-14
- 刪除條件：新版三層架構測試通過 + 前後端整合完成
